  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-red-600 text-destructive-foreground shadow-sm hover:bg-destructive/95",
        outline:
        ...
        variantOutline:
          "border-colorPrimary border-2 shadow text-colorPrimary sm:hover:bg-colorPrimary/90 sm:hover:text-colorBack font-bold",
      },
      size: {
